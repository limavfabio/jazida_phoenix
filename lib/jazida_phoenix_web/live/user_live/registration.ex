defmodule JazidaPhoenixWeb.UserLive.Registration do
      ...
      <div class="mx-auto max-w-sm px-4 py-16">
        <div class="text-center">
          <.header>
            ...
            <:subtitle>
              Já tem cadastro?
              <.link navigate={~p"/users/log-in"} class="font-semibold text-[#ff5d39] hover:underline">
                Entre
              </.link>
              agora.
            </:subtitle>
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: JazidaPhoenixWeb.UserAuth.signed_in_path(socket))}
  end
    ...
    case Accounts.register_user(user_params) do
      {:ok, user} ->
        ...
        {:noreply,
         ...
         |> put_flash(
           :info,
           "Enviamos uma mensagem para #{user.email}. Acesse o link para confirmar sua conta."
         )
