defmodule JazidaPhoenixWeb.UserLive.Settings do
  use JazidaPhoenixWeb, :live_view

  on_mount {JazidaPhoenixWeb.UserAuth, :require_sudo_mode}
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-xl px-4 pt-16 text-center">
        <.header>
      ...
      <.form
        ...
        class="mx-auto mt-8 max-w-xl rounded-2xl bg-white p-6 shadow-sm"
      >
        <.input
      ...
      <div class="mx-auto my-8 h-px max-w-xl bg-[#183128]/10" />
  ...
  def handle_event("update_email", params, socket) do
    ...
    case Accounts.change_user_email(user, user_params) do
      %{valid?: true} = changeset ->
        ...
        info = "Enviamos ao novo endereço um link para confirmar a alteração de e-mail."
